...
export async function listUsageForDay(db: Env["grok2api"], day: string): Promise<ApiKeyUsageRow[]> {
...
export async function ensureUsageRow(db: Env["grok2api"], key: string, day: string, atMs: number): Promise<void> {
  await db
