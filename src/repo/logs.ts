...
export async function getRequestLogs(db: Env["grok2api"], limit = 1000): Promise<RequestLogRow[]> {
...
export async function clearRequestLogs(db: Env["grok2api"]): Promise<void> {
...
export async function getRequestStats(db: Env["grok2api"]): Promise<RequestStats> {
  const now = nowMs();
